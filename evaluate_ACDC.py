...
parser.add_argument('--test_dir', dest='test_dir',
                    default='/home/ray/workspace/PommesPeter/lowlight-enhancement-research/KinD_plus/simple',
...
illmin_name = "illumination_adjust_curve_net_global_rm_del_rotate_no_random_acdc"
...
decom_checkpoint_dir = os.path.join(args.checkpoint_dir, 'decom_net_retrain_acdc')
...
checkpoint_dir_restoration = os.path.join(args.checkpoint_dir, 'new_restoration_retrain_acdc')

...
for epoch in range(start_epoch, epoch):
    ...
    for batch_id in range(start_step, numBatch):
        ...
        for patch_id in range(batch_size):
            ...
            batch_input_low_m[patch_id, :, :, :] = data_augmentation(m_low_expand, rand_mode)
            batch_input_high_m[patch_id, :, :, :] = data_augmentation(m_high_expand, rand_mode)

            batch_input_low_ri[patch_id, :, :, :] = data_augmentation(ri_low_data_crop, rand_mode)
            batch_input_high_ri[patch_id, :, :, :] = data_augmentation(ri_high_data_crop, rand_mode)
            batch_input_low_rm[patch_id, :, :, :] = data_augmentation(rm_low_expand, rand_mode)
            batch_input_high_rm[patch_id, :, :, :] = data_augmentation(rm_high_expand, rand_mode)

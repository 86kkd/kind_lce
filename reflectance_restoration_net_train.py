...
eval_low_data_name = glob(os.path.join(data, 'our485/low/*.png'))+ glob(os.path.join(data,'add_sys/sys_low/*.png'))+ glob(os.path.join(data,'dark/low/*.png'))
...
eval_high_data_name = glob(os.path.join(data,
                                        'our485/high/*.png')) + glob(os.path.join(data,'add_sys/sys_high/*.png'))+ glob(os.path.join(data,'dark/high/*.png'))
